...
C_SRCS += \
../Middlewares/Third_Party/FreeRTOS-Plus/ThirdParty/wolfSSL/examples/server/server.c 

OBJS += \
./Middlewares/Third_Party/FreeRTOS-Plus/ThirdParty/wolfSSL/examples/server/server.o 

C_DEPS += \
./Middlewares/Third_Party/FreeRTOS-Plus/ThirdParty/wolfSSL/examples/server/server.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/FreeRTOS-Plus/ThirdParty/wolfSSL/examples/server/%.o Middlewares/Third_Party/FreeRTOS-Plus/ThirdParty/wolfSSL/examples/server/%.su: ../Middlewares/Third_Party/FreeRTOS-Plus/ThirdParty/wolfSSL/examples/server/%.c Middlewares/Third_Party/FreeRTOS-Plus/ThirdParty/wolfSSL/examples/server/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-FreeRTOS-2d-Plus-2f-ThirdParty-2f-wolfSSL-2f-examples-2f-server

clean-Middlewares-2f-Third_Party-2f-FreeRTOS-2d-Plus-2f-ThirdParty-2f-wolfSSL-2f-examples-2f-server:
	-$(RM) ./Middlewares/Third_Party/FreeRTOS-Plus/ThirdParty/wolfSSL/examples/server/server.d ./Middlewares/Third_Party/FreeRTOS-Plus/ThirdParty/wolfSSL/examples/server/server.o ./Middlewares/Third_Party/FreeRTOS-Plus/ThirdParty/wolfSSL/examples/server/server.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-FreeRTOS-2d-Plus-2f-ThirdParty-2f-wolfSSL-2f-examples-2f-server
