...
C_SRCS += \
../Middlewares/Third_Party/wolfssl/examples/server/server.c 

OBJS += \
./Middlewares/Third_Party/wolfssl/examples/server/server.o 

C_DEPS += \
./Middlewares/Third_Party/wolfssl/examples/server/server.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/wolfssl/examples/server/%.o Middlewares/Third_Party/wolfssl/examples/server/%.su: ../Middlewares/Third_Party/wolfssl/examples/server/%.c Middlewares/Third_Party/wolfssl/examples/server/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-wolfssl-2f-examples-2f-server

clean-Middlewares-2f-Third_Party-2f-wolfssl-2f-examples-2f-server:
	-$(RM) ./Middlewares/Third_Party/wolfssl/examples/server/server.d ./Middlewares/Third_Party/wolfssl/examples/server/server.o ./Middlewares/Third_Party/wolfssl/examples/server/server.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-wolfssl-2f-examples-2f-server
