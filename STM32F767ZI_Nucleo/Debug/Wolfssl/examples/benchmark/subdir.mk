...
C_SRCS += \
../Wolfssl/examples/benchmark/tls_bench.c 

OBJS += \
./Wolfssl/examples/benchmark/tls_bench.o 

C_DEPS += \
./Wolfssl/examples/benchmark/tls_bench.d 


# Each subdirectory must supply rules for building sources it contributes
Wolfssl/examples/benchmark/%.o Wolfssl/examples/benchmark/%.su: ../Wolfssl/examples/benchmark/%.c Wolfssl/examples/benchmark/subdir.mk
...
clean: clean-Wolfssl-2f-examples-2f-benchmark

clean-Wolfssl-2f-examples-2f-benchmark:
	-$(RM) ./Wolfssl/examples/benchmark/tls_bench.d ./Wolfssl/examples/benchmark/tls_bench.o ./Wolfssl/examples/benchmark/tls_bench.su

.PHONY: clean-Wolfssl-2f-examples-2f-benchmark
