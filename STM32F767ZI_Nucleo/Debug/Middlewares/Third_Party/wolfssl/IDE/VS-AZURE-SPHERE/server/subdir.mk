...
C_SRCS += \
../Middlewares/Third_Party/wolfssl/IDE/VS-AZURE-SPHERE/server/server.c 

OBJS += \
./Middlewares/Third_Party/wolfssl/IDE/VS-AZURE-SPHERE/server/server.o 

C_DEPS += \
./Middlewares/Third_Party/wolfssl/IDE/VS-AZURE-SPHERE/server/server.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/wolfssl/IDE/VS-AZURE-SPHERE/server/%.o Middlewares/Third_Party/wolfssl/IDE/VS-AZURE-SPHERE/server/%.su: ../Middlewares/Third_Party/wolfssl/IDE/VS-AZURE-SPHERE/server/%.c Middlewares/Third_Party/wolfssl/IDE/VS-AZURE-SPHERE/server/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-wolfssl-2f-IDE-2f-VS-2d-AZURE-2d-SPHERE-2f-server

clean-Middlewares-2f-Third_Party-2f-wolfssl-2f-IDE-2f-VS-2d-AZURE-2d-SPHERE-2f-server:
	-$(RM) ./Middlewares/Third_Party/wolfssl/IDE/VS-AZURE-SPHERE/server/server.d ./Middlewares/Third_Party/wolfssl/IDE/VS-AZURE-SPHERE/server/server.o ./Middlewares/Third_Party/wolfssl/IDE/VS-AZURE-SPHERE/server/server.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-wolfssl-2f-IDE-2f-VS-2d-AZURE-2d-SPHERE-2f-server
