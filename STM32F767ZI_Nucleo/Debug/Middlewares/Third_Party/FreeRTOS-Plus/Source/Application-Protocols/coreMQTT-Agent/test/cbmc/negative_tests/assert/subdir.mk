...
C_SRCS += \
../Middlewares/Third_Party/FreeRTOS-Plus/Source/Application-Protocols/coreMQTT-Agent/test/cbmc/negative_tests/assert/assert_harness.c 

OBJS += \
./Middlewares/Third_Party/FreeRTOS-Plus/Source/Application-Protocols/coreMQTT-Agent/test/cbmc/negative_tests/assert/assert_harness.o 

C_DEPS += \
./Middlewares/Third_Party/FreeRTOS-Plus/Source/Application-Protocols/coreMQTT-Agent/test/cbmc/negative_tests/assert/assert_harness.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/FreeRTOS-Plus/Source/Application-Protocols/coreMQTT-Agent/test/cbmc/negative_tests/assert/%.o Middlewares/Third_Party/FreeRTOS-Plus/Source/Application-Protocols/coreMQTT-Agent/test/cbmc/negative_tests/assert/%.su: ../Middlewares/Third_Party/FreeRTOS-Plus/Source/Application-Protocols/coreMQTT-Agent/test/cbmc/negative_tests/assert/%.c Middlewares/Third_Party/FreeRTOS-Plus/Source/Application-Protocols/coreMQTT-Agent/test/cbmc/negative_tests/assert/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-FreeRTOS-2d-Plus-2f-Source-2f-Application-2d-Protocols-2f-coreMQTT-2d-Agent-2f-test-2f-cbmc-2f-negative_tests-2f-assert

clean-Middlewares-2f-Third_Party-2f-FreeRTOS-2d-Plus-2f-Source-2f-Application-2d-Protocols-2f-coreMQTT-2d-Agent-2f-test-2f-cbmc-2f-negative_tests-2f-assert:
	-$(RM) ./Middlewares/Third_Party/FreeRTOS-Plus/Source/Application-Protocols/coreMQTT-Agent/test/cbmc/negative_tests/assert/assert_harness.d ./Middlewares/Third_Party/FreeRTOS-Plus/Source/Application-Protocols/coreMQTT-Agent/test/cbmc/negative_tests/assert/assert_harness.o ./Middlewares/Third_Party/FreeRTOS-Plus/Source/Application-Protocols/coreMQTT-Agent/test/cbmc/negative_tests/assert/assert_harness.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-FreeRTOS-2d-Plus-2f-Source-2f-Application-2d-Protocols-2f-coreMQTT-2d-Agent-2f-test-2f-cbmc-2f-negative_tests-2f-assert
