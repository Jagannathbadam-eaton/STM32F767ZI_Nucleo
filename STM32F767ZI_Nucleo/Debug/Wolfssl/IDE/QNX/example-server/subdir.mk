...
C_SRCS += \
../Wolfssl/IDE/QNX/example-server/server-tls.c 

OBJS += \
./Wolfssl/IDE/QNX/example-server/server-tls.o 

C_DEPS += \
./Wolfssl/IDE/QNX/example-server/server-tls.d 


# Each subdirectory must supply rules for building sources it contributes
Wolfssl/IDE/QNX/example-server/%.o Wolfssl/IDE/QNX/example-server/%.su: ../Wolfssl/IDE/QNX/example-server/%.c Wolfssl/IDE/QNX/example-server/subdir.mk
...
clean: clean-Wolfssl-2f-IDE-2f-QNX-2f-example-2d-server

clean-Wolfssl-2f-IDE-2f-QNX-2f-example-2d-server:
	-$(RM) ./Wolfssl/IDE/QNX/example-server/server-tls.d ./Wolfssl/IDE/QNX/example-server/server-tls.o ./Wolfssl/IDE/QNX/example-server/server-tls.su

.PHONY: clean-Wolfssl-2f-IDE-2f-QNX-2f-example-2d-server
