...
#include "azure/azure_iot_hub_client.h"
#include "azure/azure_iot_provisioning_client.h"
...
#include "FreeRTOS.h"
#include "task.h"
#include "common/utilities/crypto.h"
 ...
 */
#define sampleazureiotMESSAGE                                 "Hello World, Welcome to Eaton STM32F767ZI device : %d !"
