...
C_SRCS += \
../Wolfssl/IDE/MSVS-2019-AZSPHERE/server/server.c 

OBJS += \
./Wolfssl/IDE/MSVS-2019-AZSPHERE/server/server.o 

C_DEPS += \
./Wolfssl/IDE/MSVS-2019-AZSPHERE/server/server.d 


# Each subdirectory must supply rules for building sources it contributes
Wolfssl/IDE/MSVS-2019-AZSPHERE/server/%.o Wolfssl/IDE/MSVS-2019-AZSPHERE/server/%.su: ../Wolfssl/IDE/MSVS-2019-AZSPHERE/server/%.c Wolfssl/IDE/MSVS-2019-AZSPHERE/server/subdir.mk
...
clean: clean-Wolfssl-2f-IDE-2f-MSVS-2d-2019-2d-AZSPHERE-2f-server

clean-Wolfssl-2f-IDE-2f-MSVS-2d-2019-2d-AZSPHERE-2f-server:
	-$(RM) ./Wolfssl/IDE/MSVS-2019-AZSPHERE/server/server.d ./Wolfssl/IDE/MSVS-2019-AZSPHERE/server/server.o ./Wolfssl/IDE/MSVS-2019-AZSPHERE/server/server.su

.PHONY: clean-Wolfssl-2f-IDE-2f-MSVS-2d-2019-2d-AZSPHERE-2f-server
