...
OBJS += \
./Middlewares/Third_Party/wolfssl/wolfcrypt/test/test.o 

C_DEPS += \
./Middlewares/Third_Party/wolfssl/wolfcrypt/test/test.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/wolfssl/wolfcrypt/test/%.o Middlewares/Third_Party/wolfssl/wolfcrypt/test/%.su: ../Middlewares/Third_Party/wolfssl/wolfcrypt/test/%.c Middlewares/Third_Party/wolfssl/wolfcrypt/test/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-wolfssl-2f-wolfcrypt-2f-test

clean-Middlewares-2f-Third_Party-2f-wolfssl-2f-wolfcrypt-2f-test:
	-$(RM) ./Middlewares/Third_Party/wolfssl/wolfcrypt/test/test.d ./Middlewares/Third_Party/wolfssl/wolfcrypt/test/test.o ./Middlewares/Third_Party/wolfssl/wolfcrypt/test/test.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-wolfssl-2f-wolfcrypt-2f-test
