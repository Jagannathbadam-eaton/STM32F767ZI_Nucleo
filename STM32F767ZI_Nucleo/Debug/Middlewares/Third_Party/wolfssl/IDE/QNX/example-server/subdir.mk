...
C_SRCS += \
../Middlewares/Third_Party/wolfssl/IDE/QNX/example-server/server-tls.c 

OBJS += \
./Middlewares/Third_Party/wolfssl/IDE/QNX/example-server/server-tls.o 

C_DEPS += \
./Middlewares/Third_Party/wolfssl/IDE/QNX/example-server/server-tls.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/wolfssl/IDE/QNX/example-server/%.o Middlewares/Third_Party/wolfssl/IDE/QNX/example-server/%.su: ../Middlewares/Third_Party/wolfssl/IDE/QNX/example-server/%.c Middlewares/Third_Party/wolfssl/IDE/QNX/example-server/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-wolfssl-2f-IDE-2f-QNX-2f-example-2d-server

clean-Middlewares-2f-Third_Party-2f-wolfssl-2f-IDE-2f-QNX-2f-example-2d-server:
	-$(RM) ./Middlewares/Third_Party/wolfssl/IDE/QNX/example-server/server-tls.d ./Middlewares/Third_Party/wolfssl/IDE/QNX/example-server/server-tls.o ./Middlewares/Third_Party/wolfssl/IDE/QNX/example-server/server-tls.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-wolfssl-2f-IDE-2f-QNX-2f-example-2d-server
