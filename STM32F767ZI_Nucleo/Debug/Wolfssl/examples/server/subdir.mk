...
OBJS += \
./Wolfssl/examples/server/server.o 

C_DEPS += \
./Wolfssl/examples/server/server.d 


# Each subdirectory must supply rules for building sources it contributes
Wolfssl/examples/server/%.o Wolfssl/examples/server/%.su: ../Wolfssl/examples/server/%.c Wolfssl/examples/server/subdir.mk
...
clean: clean-Wolfssl-2f-examples-2f-server

clean-Wolfssl-2f-examples-2f-server:
	-$(RM) ./Wolfssl/examples/server/server.d ./Wolfssl/examples/server/server.o ./Wolfssl/examples/server/server.su

.PHONY: clean-Wolfssl-2f-examples-2f-server
