...
C_SRCS += \
../Core/sample_azure_iot/sample_azure_iot.c 

OBJS += \
./Core/sample_azure_iot/sample_azure_iot.o 

C_DEPS += \
./Core/sample_azure_iot/sample_azure_iot.d 


# Each subdirectory must supply rules for building sources it contributes
Core/sample_azure_iot/%.o Core/sample_azure_iot/%.su: ../Core/sample_azure_iot/%.c Core/sample_azure_iot/subdir.mk
...
clean: clean-Core-2f-sample_azure_iot

clean-Core-2f-sample_azure_iot:
	-$(RM) ./Core/sample_azure_iot/sample_azure_iot.d ./Core/sample_azure_iot/sample_azure_iot.o ./Core/sample_azure_iot/sample_azure_iot.su

.PHONY: clean-Core-2f-sample_azure_iot
