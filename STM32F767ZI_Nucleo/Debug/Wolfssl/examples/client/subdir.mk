...
OBJS += \
./Wolfssl/examples/client/client.o 

C_DEPS += \
./Wolfssl/examples/client/client.d 


# Each subdirectory must supply rules for building sources it contributes
Wolfssl/examples/client/%.o Wolfssl/examples/client/%.su: ../Wolfssl/examples/client/%.c Wolfssl/examples/client/subdir.mk
...
clean: clean-Wolfssl-2f-examples-2f-client

clean-Wolfssl-2f-examples-2f-client:
	-$(RM) ./Wolfssl/examples/client/client.d ./Wolfssl/examples/client/client.o ./Wolfssl/examples/client/client.su

.PHONY: clean-Wolfssl-2f-examples-2f-client
